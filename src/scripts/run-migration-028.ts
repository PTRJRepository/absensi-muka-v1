/**
 * Run Migration 028: Fix attendance_imports wrong codes
 * Usage: npx ts-node src/scripts/run-migration-028.ts
 */
...
async function main() {
  ...
  console.log('============================================================');
  console.log('MIGRATION 028: Fix attendance_imports wrong codes');
  console.log('============================================================');
  console.log('');
  ...
  const sqlFile = 'migrations/028_fix_attendance_imports_wrong_codes.sql';
