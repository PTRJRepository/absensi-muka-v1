/**
 * Run Migration 033: Reactivate enrolled employees in zkteco_hr_employee_map
 * Usage: npx ts-node src/scripts/run-migration-033.ts
 */
...
async function main() {
  ...
  console.log('============================================================');
  console.log('MIGRATION 033: Reactivate enrolled employees');
  console.log('============================================================');
  console.log('');
  ...
  const sqlFile = 'migrations/033_reactivate_enrolled_employees.sql';
