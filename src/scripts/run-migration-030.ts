/**
 * Run Migration 030: Fix zkteco_hr_employee_map NULL hr_employee_code
 * Usage: npx ts-node src/scripts/run-migration-030.ts
 */
...
async function main() {
  ...
  console.log('============================================================');
  console.log('MIGRATION 030: Fix zkteco_hr_employee_map NULL codes');
  console.log('============================================================');
  console.log('');
  ...
  const sqlFile = 'migrations/030_fix_zkteco_hr_employee_map_nulls.sql';
