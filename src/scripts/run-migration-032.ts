/**
 * Run Migration 032: Fix attendance_imports wrong employee codes
 * Usage: npx ts-node src/scripts/run-migration-032.ts
 */
...
async function main() {
  ...
  console.log('============================================================');
  console.log('MIGRATION 032: Fix attendance_imports wrong employee codes');
  console.log('============================================================');
  console.log('');
  ...
  const sqlFile = 'migrations/032_fix_attendance_imports_wrong_codes.sql';
