/**
 * Run Migration 031: Fix remaining NULL parsed_employee_code for long IDs with scanner prefix
 * Usage: npx ts-node src/scripts/run-migration-031.ts
 */
...
async function main() {
  ...
  console.log('============================================================');
  console.log('MIGRATION 031: Fix remaining NULL parsed_employee_code');
  console.log('============================================================');
  console.log('');
  ...
  const sqlFile = 'migrations/031_fix_remaining_null_long_ids.sql';
